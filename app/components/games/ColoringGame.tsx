...
const TEMPLATES = {
  // ─── NIVO 1: LOPTA ────────────────────────────────────────────────────────────
  1: [
    { id: 1, path: "M200,225 m-150,0 a150,150 0 1,0 300,0 a150,150 0 1,0 -300,0", targetColor: "#FBBF24" },
    { id: 2, path: "M200,225 L120,100 A150,150 0 0,1 280,100 Z", targetColor: "#EF4444" },
    { id: 3, path: "M200,225 L120,350 A150,150 0 0,0 280,350 Z", targetColor: "#3B82F6" },
  ...
  // ─── NIVO 3: SLADOLED ────────────────────────────────────────────────────────
  3: [
    { id: 1, path: "M150,250 L250,250 L200,400 Z", targetColor: "#F59E0B" },
    { id: 2, path: "M160,250 L200,380", targetColor: "#D97706", stroke: true },
    { id: 3, path: "M240,250 L200,380", targetColor: "#D97706", stroke: true },
    { id: 4, path: "M140,250 Q200,220 260,250 A60,60 0 0,0 140,250 Z", targetColor: "#EC4899" },
    { id: 5, path: "M150,200 A50,50 0 1,1 250,200 Z", targetColor: "#EC4899" },
    { id: 6, path: "M200,150 m-15,0 a15,15 0 1,0 30,0 a15,15 0 1,0 -30,0", targetColor: "#EF4444" },
    { id: 7, path: "M200,135 Q220,100 230,110", targetColor: "#10B981", stroke: true },
  ],

  // ─── NIVO 4: BROD ────────────────────────────────────────────────────────────
  4: [
    { id: 1, path: "M100,280 L300,280 L270,350 L130,350 Z", targetColor: "#92400E" },
    { id: 2, path: "M195,100 L110,260 L195,260 Z", targetColor: "#F3F4F6" },
    { id: 3, path: "M205,120 L270,260 L205,260 Z", targetColor: "#3B82F6" },
    { id: 4, path: "M195,80 L205,80 L205,280 L195,280 Z", targetColor: "#1F2937" },
    { id: 5, path: "M205,80 L250,95 L205,110 Z", targetColor: "#EF4444" },
    { id: 6, path: "M50,330 Q100,320 150,340 T250,340 T350,330 L350,380 L50,380 Z", targetColor: "#60A5FA" },
    { id: 7, path: "M20,350 Q70,340 120,360 T220,360 T320,350 L380,350 L380,410 L20,410 Z", targetColor: "#3B82F6" },
  ],

  // ─── NIVO 5: RAKETA ──────────────────────────────────────────────────────────
  5: [
    { id: 1, path: "M200,50 Q250,150 250,250 L150,250 Q150,150 200,50 Z", targetColor: "#F3F4F6" },
    { id: 2, path: "M150,200 L100,300 L150,250 Z", targetColor: "#EF4444" },
    { id: 3, path: "M250,200 L300,300 L250,250 Z", targetColor: "#EF4444" },
    { id: 4, path: "M170,250 L230,250 L210,280 L190,280 Z", targetColor: "#6B7280" },
    { id: 5, path: "M200,150 m-25,0 a25,25 0 1,0 50,0 a25,25 0 1,0 -50,0", targetColor: "#1F2937" },
    { id: 6, path: "M200,150 m-15,0 a15,15 0 1,0 30,0 a15,15 0 1,0 -30,0", targetColor: "#60A5FA" },
    { id: 7, path: "M190,280 L210,280 L200,350 Z", targetColor: "#F97316" },
    { id: 8, path: "M195,280 L205,280 L200,320 Z", targetColor: "#FBBF24" },
  ],

  // ─── NIVO 6: KRUNA ───────────────────────────────────────────────────────────
  6: [
    { id: 1, path: "M120,300 L280,300 L290,340 L110,340 Z", targetColor: "#FBBF24" },
    { id: 2, path: "M120,300 L80,150 L160,250 L200,120 L240,250 L320,150 L280,300 Z", targetColor: "#F59E0B" },
    { id: 3, path: "M200,110 m-15,0 a15,15 0 1,0 30,0 a15,15 0 1,0 -30,0", targetColor: "#EF4444" },
    { id: 4, path: "M80,140 m-10,0 a10,10 0 1,0 20,0 a10,10 0 1,0 -20,0", targetColor: "#3B82F6" },
    { id: 5, path: "M320,140 m-10,0 a10,10 0 1,0 20,0 a10,10 0 1,0 -20,0", targetColor: "#3B82F6" },
    { id: 6, path: "M150,320 m-10,0 a10,10 0 1,0 20,0 a10,10 0 1,0 -20,0", targetColor: "#10B981" },
    { id: 7, path: "M200,320 m-10,0 a10,10 0 1,0 20,0 a10,10 0 1,0 -20,0", targetColor: "#EF4444" },
    { id: 8, path: "M250,320 m-10,0 a10,10 0 1,0 20,0 a10,10 0 1,0 -20,0", targetColor: "#10B981" },
  ],
  ...
  // ─── NIVO 11: MEDA ────────────────────────────────────────────────────────────
  11: [
    { id: 1, path: "M150,120 m-30,0 a30,30 0 1,0 60,0 a30,30 0 1,0 -60,0", targetColor: "#92400E" },
    { id: 2, path: "M250,120 m-30,0 a30,30 0 1,0 60,0 a30,30 0 1,0 -60,0", targetColor: "#92400E" },
    { id: 3, path: "M150,120 m-15,0 a15,15 0 1,0 30,0 a15,15 0 1,0 -30,0", targetColor: "#FCA5A5" },
    { id: 4, path: "M250,120 m-15,0 a15,15 0 1,0 30,0 a15,15 0 1,0 -30,0", targetColor: "#FCA5A5" },
    { id: 5, path: "M200,200 m-80,0 a80,80 0 1,0 160,0 a80,80 0 1,0 -160,0", targetColor: "#D97706" },
    { id: 6, path: "M200,230 m-40,0 a40,30 0 1,0 80,0 a40,30 0 1,0 -80,0", targetColor: "#FDE68A" },
    { id: 7, path: "M200,215 m-15,0 a15,10 0 1,0 30,0 a15,10 0 1,0 -30,0", targetColor: "#1F2937" },
    { id: 8, path: "M200,340 m-70,0 a70,90 0 1,0 140,0 a70,90 0 1,0 -140,0", targetColor: "#D97706" },
    { id: 9, path: "M200,350 m-40,0 a40,60 0 1,0 80,0 a40,60 0 1,0 -80,0", targetColor: "#FDE68A" },
    { id: 10, path: "M120,280 m-25,0 a25,40 -20 1,0 50,0 a25,40 -20 1,0 -50,0", targetColor: "#92400E" },
    { id: 11, path: "M280,280 m-25,0 a25,40 20 1,0 50,0 a25,40 20 1,0 -50,0", targetColor: "#92400E" },
    { id: 12, path: "M150,400 m-30,0 a30,40 -10 1,0 60,0 a30,40 -10 1,0 -60,0", targetColor: "#92400E" },
    { id: 13, path: "M250,400 m-30,0 a30,40 10 1,0 60,0 a30,40 10 1,0 -60,0", targetColor: "#92400E" },
    { id: 14, path: "M170,170 m-5,0 a5,5 0 1,0 10,0 a5,5 0 1,0 -10,0", targetColor: "#1F2937" },
    { id: 15, path: "M230,170 m-5,0 a5,5 0 1,0 10,0 a5,5 0 1,0 -10,0", targetColor: "#1F2937" },
  ],
  ...
  if (!isPlaying && completedZones === 0) {
    return (
      <div className="relative min-h-[500px] w-full flex items-center justify-center overflow-hidden rounded-[2.5rem] shadow-lg"
        style={{ 
          backgroundImage: "linear-gradient(rgba(255,255,255,0.7), rgba(255,255,255,0.7)), url('/images/oboji.png')",
        ...
        <div className="relative z-10 w-full max-w-md mx-auto p-6 flex flex-col items-center text-center">
          <div className="mb-8 animate-in slide-in-from-top-4 duration-700">
            <span className="px-6 py-2.5 rounded-full bg-white/90 backdrop-blur-sm border border-rose-100 text-rose-600 text-sm font-black uppercase tracking-widest shadow-md">
          ...
          <h2 className="text-5xl font-black text-slate-900 mb-4 tracking-tight drop-shadow-md">Bojenje</h2>
          <p className="text-slate-800 text-xl font-bold leading-relaxed mb-12 max-w-sm mx-auto">
            <span className="text-rose-600 font-black">Oboji sliku</span> bojama koje želiš! Pusti mašti na volju!
          </p>
