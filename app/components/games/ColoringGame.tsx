    ...
    return (
      <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center p-4 sm:p-10 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-slate-50">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-rose-500/10 via-white/80 to-orange-500/10 backdrop-blur-3xl" />
        </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-6 w-full max-w-4xl px-4">
            {[
              ...
              <button
                ...
                className="group relative flex flex-col items-center bg-white rounded-2xl p-4 sm:p-6 transition-all duration-300 hover:scale-105 hover:-translate-y-2 cursor-pointer shadow-lg border border-slate-100 hover:border-rose-100 animate-in zoom-in-95 duration-500"
